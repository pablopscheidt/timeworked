...
export function Checkbox({ labelCheckbox, IdCheckbox } : CheckboxProps ) {
  ...
  return (
    <label id="checkLabel" className="flex items-center gap-2 cursor-pointer w-fit">
        ...
        />
        <div className="w-5 h-5 rounded border-gray-500 border-2 flex items-center justify-center">
            <svg
                ...
                width={iconSize}
            >
                <path d="M6,10.2 L1.8,6 L0.4,7.4 L6,13 L18,1 L16.6,-0.4 L6,10.2 Z" className="fill-gray-300" />
            </svg>
        </div>
